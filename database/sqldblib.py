...
#
from employees.conf.config import database, myapp
...
#from employees.models.sql.basemodel import SqlBaseModel
from employees.models.sql.sqlmodel import SqlModel
