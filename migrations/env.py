...
from employees.lib.powlib import get_class_name
from employees.conf.config import myapp
from employees.lib.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('employees.models.sql.' + m)
...
#from employees.dblib import Base
