...
from employees.database.sqldblib import Base, Session, engine
from employees.conf.config import myapp
from employees.conf.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'employees.handlers.' + m)    
            try:
                mod = importlib.import_module('employees.handlers.' + m)
            except:
                pass
            #print(dir(mod))
