...
server_settings = {
    ...
    "cookie_secret"     :   "2cab09a7-067c-4457-a6c5-5a3f8fe5ead8"
}
...
myapp = {
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   employees.lib.encoders.json_to_json(),
            "csv"   :   employees.lib.encoders.json_to_csv(),
            "xml"   :   employees.lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
